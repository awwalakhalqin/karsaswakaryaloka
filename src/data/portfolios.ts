export const portfolios = [
  {
    slug: "aurora-beauty-clinic",
    title: "Klinik Kecantikan Aurora",
    category: "Healthcare",
    client: "Aurora Aesthetic Group",
    year: "2023",
  ...
  },
  {
    ...
    title: "Apotek Digital MedPlus",
    category: "Healthcare",
    client: "MedPlus Indonesia",
    year: "2023",
  ...
  {
    slug: "laundrypro-management",
    title: "LaundryPro Management",
    category: "Service & Lifestyle",
    client: "LaundryPro Franchise",
    year: "2022",
  ...
  {
    slug: "barberq-booking",
    title: "BarberQ Booking System",
    category: "Service & Lifestyle",
    client: "BarberQ Studio",
    year: "2024",
    description: "Aplikasi booking barber dengan antrian digital, penilaian stylist, dan loyalty program.",
    content: "Menghilangkan antrian fisik yang membosankan. Pelanggan bisa memantau nomor antrian dari rumah. Dilengkapi dengan profil stylist (rating & review) dan sistem poin yang bisa ditukar dengan potongan harga atau produk perawatan.",
  ...
  {
    slug: "hris-nusantara",
    title: "HRIS Enterprise Nusantara",
    category: "Corporate System",
    client: "Nusantara Holding Group",
    year: "2022",
    description: "Sistem HR terintegrasi: rekrutmen, absensi, payroll, dan evaluasi KPI untuk 500+ karyawan.",
    content: "Digitalisasi departemen HR untuk efisiensi maksimal. Mencakup face-recognition attendance, otomatisasi hitung payroll (pajak PPh 21, BPJS), hingga modul penilaian kinerja berbasis KPI (Key Performance Indicator).",
  ...
  {
    slug: "wisatanow-platform",
    title: "WisataNow Booking Platform",
    category: "Corporate System",
    client: "Eksplorasi Wisata Tour",
    year: "2023",
    description: "Platform booking wisata multi-vendor dengan payment gateway dan sistem komisi otomatis.",
    content: "Marketplace open-trip dan paket wisata. Memfasilitasi banyak vendor tour untuk menjual paket mereka. Sistem secara otomatis membagi hasil penjualan ke vendor, agen, dan admin secara real-time melalui integrasi payment gateway lokal.",
